...
Immediate or Cancel requires all or part of the order to be executed immediately. Any unfilled parts of the order are canceled.`,
  ...
  wallet_connect_title: 'Connect to WalletConnect',
  wallet_connect_title_tip: 'Allow OKExChain DEX to connect to WalletConnect to begin.',
  wallet_connect_error: 'Failed to connect：Already processing requestAccounts. Please wait.',
  wallet_connect_ensure: 'Connect',
  wallet_connect_ensureing: 'Connecting',
  wallet_connect_qrcode: 'WalletConnect',
  wallet_connect_qrcodedesc: 'Scan QR code with OKEx App above version of 4.6.9',
  ...
  'White listed help': `What's white listed pool`,
  ...
  'Confirm Reduce btn': 'Confirm Reduce',
  ...
  'pool tokens': 'LP ({base}/{quote}) Pool Tokens',
  'reduce liquidity warn tip':
    'Output is estimated.If the price changes by more than {num}% your transaction will revert.',
  'UNI Burned': 'Burn LP ({base}/{quote})',
  'swap warn tip2':
  ...
  assets_address_OKExChain: 'Corresponding OKExChain address',
  assets_column_type: 'Type',
  assets_column_total: 'Balance',
  assets_more_btn: 'More',
  trade_column_num: 'Amount',
  trade_type_in: 'In',
  trade_type_out: 'Out',
  dex_top_tip: 'OKExChain is compatible with the Ethereum address format. You can use the address used for your Ethereum account in your Ethereum wallet(such as MetaMask). ',
  for_details: 'Learn more',
  dex_popup_tip: 'OKExChain and Ethererum are generated by the same public key with different algorithms, and they share the account balance.',
  view_detail: 'View more',
  add_assets: 'Add asset',
  dex_address_expanded: 'Unfold dual address',
  dex_address_packup: 'Fold',
  dex_address_label: 'Corresponding OKExChain address',
  dex_address_double: 'What is a dual address?',
  dex_more_detail: 'Details',
  dex_more_migration: 'Move',
  dex_more_hidden: 'Hide',
  dex_input_label_contract: 'Enter the contract address of the token',
  dex_input_label_short_name: 'Token symbol',
  dex_input_label_precision: 'Decimals of Precision',
  dex_input_err_tip_contract_default: 'Please enter a contract address in the correct format.',
  dex_input_err_tip_contract_repeat: 'Token has already been added.',
  dex_input_err_tip_contract_useraddr: 'This address belongs to a personal account.',
  dex_input_err_tip_contract_err: 'Data request failed, please enter again.',
  dex_input_err_tip_short_name: 'Please enter token symbol.',
  dex_input_err_tip_precision: 'Please enter decimals of precision',
  dex_input_err_tip_precision2: 'Please enter a number between 0 ~ 18.',
  import_mnemonic_article_title: 'OKExChain address upgraded!',
  import_mnemonic_article_content1: 'After the upgrade, OKExChain will be compatible with Ethereum address(0x), and users will be able to manage their assets on Ethereum and OKExChain just with one address.',
  import_mnemonic_article_content2: 'If you have created a wallet and held assets before the mainnet upgrade（2021/3/1 12:00), please choose “Old account” after entering the mnemonic phrase. To avoid losses, keep your private key safe.',
  import_mnemonic_article_content3: 'If you newly onboard and favor Ethereum wallets(like MetaMask), you can choose “New account.”',
  import_mnemonic_select_title: 'Choose your account type',
  import_mnemonic_new_user: 'New account（{addr}，Balance：{num} OKT）',
  import_mnemonic_old_user: 'Old account（{addr}，Balance：{num} OKT）',
  import_mnemonic_new_instructions: 'Manage your OKExChain & Ethereum account with one mnemonic phrase. ',
  import_mnemonic_old_instructions: 'The original path of OKExChain before the mainnet upgrade.',
  import_mnemonic_path_tip: 'Note: Please choose the old account if you have created or imported a wallet by 2021/3/1 12:00.',
  import_mnemonic_know_button: 'Got it',
  wallet_transaction_records_tab10: 'KIP 10 Transaction',
  wallet_transaction_records_tab20: 'KIP 20 Transaction',
};
export default enUS;
