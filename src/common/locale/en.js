const enUS = {
  ...
  "error.code.62003": "address、base_asset and quote_asset could not be empty at the same time",
  ...
  "error.code.63023": "Numbers of CancelOrderItem should not be bigger than limit",
  ...
  "error.code.64000": "address、base_asset and quote_asset could not be empty at the same time",
  ...
  "error.code.64013": "failed to deposit because deposits only support %s token",
  "error.code.64014": "insufficient deposit coins",
  "error.code.64015": "failed to withdraws because deposits only support %s token",
  ...
  "error.code.64031": "the product(%s) is transferring ownership,not allowed to be deposited",
  ...
  "error.code.65037": "min bought token amount is negative or not validate denom",
  ...
  "error.code.67043": "delegator isn't allowed to bind proxy while it has added shares",
  "error.code.67044": "delegator doesn't exist",
  "error.code.67045": "duplicate target validators",
  "error.code.67046": "delegator has already bound a proxy, can not register proxy",
  ...
  "error.code.67815": "community pool does not have sufficient coins to distribute",
...
Immediate or Cancel requires all or part of the order to be executed immediately. Any unfilled parts of the order are canceled.`,
  ...
  'White listed help desc': 'Whitelist pools are generated by  proposal. Any project could propose their token farm pool to whitelist. Once proposal is approved, this token farm pool will receive an additional 0.5 OKT per block as  a whitelist pool. Non-whitelist is a normal pool without OKT reward.',
