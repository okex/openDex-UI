...
Immediate or Cancel requires all or part of the order to be executed immediately. Any unfilled parts of the order are canceled.`,
  ...
  'lp token transfer':
    'I understand that the LP token deposited to OKEx exchange will not be retrieved.',
  ...
  import_mnemonic_article_content1:
    'After the upgrade, OKExChain will be compatible with Ethereum address(0x), and users will be able to manage their assets on Ethereum and OKExChain just with one address.',
  import_mnemonic_article_content2:
    'If you have created a wallet and held assets before the mainnet upgrade（2021/3/1 12:00), please choose “Old account” after entering the mnemonic phrase. To avoid losses, keep your private key safe.',
  import_mnemonic_article_content3:
    'If you newly onboard and favor Ethereum wallets(like MetaMask), you can choose “New account.”',
  ...
  import_mnemonic_new_instructions:
    'Manage your OKExChain & Ethereum account with one mnemonic phrase. ',
  import_mnemonic_old_instructions:
    'The original path of OKExChain before the mainnet upgrade.',
  import_mnemonic_path_tip:
    'Note: Please choose the old account if you have created or imported a wallet by 2021/3/1 12:00.',
