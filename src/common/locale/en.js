...
Immediate or Cancel requires all or part of the order to be executed immediately. Any unfilled parts of the order are canceled.`,
  ...
  wallet_connect_title_tip: 'Allow Switcheo to connect to WalletConnect to begin.',
  wallet_connect_error: 'Failed to connect：Already processing eth_requestAccounts. Please wait.',
  wallet_connect_ensure: 'Connect',
  wallet_connect_ensureing: 'Conecting',
  wallet_connect_qrcode: 'WalletConnect',
  wallet_connect_qrcodedesc: 'Scan QR code with a WalletConnect-compatible wallet.',
