...
Immediate or Cancel requires all or part of the order to be executed immediately. Any unfilled parts of the order are canceled.`,
  ...
  wallet_connect_title_tip:
    'Allow OKExChain DEX to connect to WalletConnect to begin.',
  ...
  'lp introduce':
    "You will get LP Token after add liquidity, it's your proof of market making.",
  ...
  assets_address_OKExChain: 'ex-address',
  ...
  trade_type_out: 'Out',
  dex_top_tip:
    'OKExChain is compatible with the Ethereum address format. You can use the address used for your Ethereum account in your Ethereum wallet(such as MetaMask). ',
  for_details: 'Learn more',
  dex_popup_tip:
    'OKExChain and Ethererum are generated by the same public key with different algorithms, and they share the account balance.',
  ...
  dex_input_err_tip_contract_default:
    'Please enter a contract address in the correct format.',
  dex_input_err_tip_contract_repeat: 'Token has already been added.',
  dex_input_err_tip_contract_useraddr:
    'This address belongs to a personal account.',
  ...
  import_mnemonic_article_content2: 'If you have created a wallet and held assets before the mainnet upgrade（2021/4/26 10:00 UTC), please choose “Old account” after entering the mnemonic phrase. To avoid losses, keep your private key safe.',
  ...
  import_mnemonic_path_tip: 'Note: Please choose the old account if you have created or imported a wallet by 2021/4/26 10:00(UTC).',
