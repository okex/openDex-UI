const zhCN = {
  ...
  'error.code.60009': '未知地址',
  'error.code.60010': '无效币种',
  'error.code.60011': 'gas不足',
  'error.code.60012': 'memo太长',
  'error.code.60013': '手续费不足',
  'error.code.60014': '签名数量超过限制',
  'error.code.60015': '交易未签名',
  'error.code.60016': '转化json格式失败',
  'error.code.60017': '反解析json格式失败',
  'error.code.60018': '无效请求',
  'error.code.60019': '交易已进入mempool',
  'error.code.60020': 'mempool已满',
  'error.code.60021': '交易字节过大',
  'error.code.60099': 'cosmos异常',
  'error.code.60100': '内部错误',
  'error.code.60101': '分页参数无效',
  'error.code.60102': '地址无效',
  'error.code.60103': '转化json格式失败',
  'error.code.60104': '反解析json格式失败',
  'error.code.60105': '字符串转化为数字错误',
  'error.code.60106': '未知的提案类型',
  'error.code.60107': 'coin不足',
  'error.code.60108': '输入参数缺失',
  'error.code.60109': '非法的请求参数',
  'error.code.60110': '内部服务错误',
  'error.code.60111': '数据为空',
  'error.code.60112': '解析服务内部值失败',
  'error.code.60113': '内部abci查询失败',
  'error.code.60114': '参数数量限制',
  ...
  'White listed help desc':
    '白名单池通过提案产生。任何一个项目方都可以提案自己的Farm池变成白名单Farm池。一旦提案通过成为白名单池，那么这个Farm池可以根据抵押金额按比例额外获得每个区块产生的0.5个okt奖励。',
  'Total staked：': '总质押：',
  'Pool rate：': '挖矿速率：',
  STAKE: '质押',
  UNSTAKE: '赎回',
  ...
  'Finish at': '结束时间',
  'Search pool': '搜索Farm池',
  'Haven’t farmed yet': '还没开始挖矿? 快去质押获得 ',
  APY: ' 年化!',
  'Go stake': '去质押',
  ...
  Unstake: '赎回',
  Number: '数字',
  'Avaliable to stake': '可质押数量: ',
  'Avaliable to unstake': '可赎回数量: ',
  'Pool ratio': '占比',
  'FARM APY': '挖矿年化收益率',
  'You didn’t have any LP tokens': '你还没有{pool_name}, 需要先添加流动性获得.',
  'Claim details': '领取详情',
  '1Day': '1天',
  'balance not enough': '余额不足',
  finished: '已结束',
  'stake min input': '输入小于最小质押数量 {num}',
  ...
  'go detail': '查看详情>',
  'check protocol': '确认',
  'Confirm Reduce': '确认减少流动性',
  'Confirm Reduce btn': '确认减少',
  'Confirm Swap': '确认兑换',
  'Confirm Supply': '确认添加流动性',
  'Confirm Supply btn': '确认添加',
  'swap warn tip':
    '获得币的数量是预估的。你至少可以获得{num} {quote}，否则交易会被退回',
  'Price Updated': '价格更新提示',
  Accept: '接受',
  'unstake confirm info':
    '头矿奖励将在2021/1/26  18:00（UTC+8）释放，如果你在这个时间之前你没有LP token质押到头矿池，你将无法领取奖励。',
  ...
  dex_top_tip: '由于 OKExChain 主网升级，现兼容以太坊地址，导入钱包时您的地址可能会发生变化，请务必备份您的私匙或 keystore 并妥善保管，避免造成资产损失',
  for_details: '了解详情',
  dex_popup_tip: '每周五将会发放鼓励金至“待领取鼓励金”，您可以在鼓励金发放后在此领取。鼓励金被领取后将会进入您的资金账户。',
  view_detail: '查看详情',
  add_assets: '添加资产',
  ...
  dex_more_hidden: '隐藏',
  dex_input_label_contract: '请输入代币合约地址',
  dex_input_label_short_name: '请输入代币简称',
  dex_input_label_precision: '请输入代币精度',
  dex_input_err_tip_contract_default: '请输入正确的合约地址',
  dex_input_err_tip_contract_repeat: '此代币已添加',
  dex_input_err_tip_contract_useraddr: '此地址是用户地址，请重新输入',
  dex_input_err_tip_contract_err: '数据获取失败，请重新输入',
  dex_input_err_tip_short_name: '请输入正确的代币简称',
  dex_input_err_tip_precision: '请输入正确的代币精度',
  dex_input_err_tip_precision2: '请输入 0 ~ 18 之间的数字',
  import_mnemonic_article_title: 'OKExChain 地址升级',
  import_mnemonic_article_content1: 'OKExChain 主网 EVM 升级后，兼容以太坊地址，并支持使用一个地址同时管理 OKExChain 和以太坊的资产。',
  ...
  import_mnemonic_select_title: '请选择账户类型',
  import_mnemonic_new_user: '新账户（{addr}，余额：{num} OKT）',
  import_mnemonic_old_user: '老账户（{addr}，余额：{num} OKT）',
  import_mnemonic_new_instructions: '使用一套助记词同时管理您的以太坊账户和OKExChain账户',
