const zhCN = {
  ...
  home_adv_item2_content: 'OKEx DEX会第一时间支持OKChain的各项新功能，提供更优的交易体验',
  home_exp_title: '体验模拟交易',
  home_exp_content: '已经创建过OKChain钱包的OKEx用户，我们将会为您发放一定数量的测试币，数量有限，先到先得。',
  ...
  home_steps_item1_content: '登录OKChain链上钱包，进入资产管理，获得OKChain链上地址；测试网可以通过领取测试币直接参与DEX交易；到账记录可在链上钱包——资产记录里面查看。',
