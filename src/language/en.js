const enUS = {
  ...
  home_adv_item2_content: 'OKEx DEX will support the new functions of OKChain sooner to providing a better trading experience for users.',
  home_exp_title: 'Experience simulated trading',
  home_exp_content: 'OKEx users who have created OKChain wallets will be distributed with a certain amount of testing currencies. The amount is limited, first come first served.',
  ...
  home_steps_item1_content: 'Log in to the OKChain on-chain wallet, enter asset management, and obtain the OKChain on-chain address; DEX trading can be initiated on TestNet by getting the test currencies; the account record can be viewed in on-chain wallet- -asset record.',
  ...
  home_subtitle: 'OKChain testnet is launched. Check your transaction history on-chain.',
